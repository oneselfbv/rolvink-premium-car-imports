...
const motoren = {
  ...
  stappen: [
    ...
    { num: '05', title: 'Transporte', body: 'Recogemos su moto en Alemania nosotros mismos — asegurada, en nuestro propio remolque con capacidad para dos motos, lo que permite combinar viajes de forma eficiente. Dentro de la UE, así que sin flete marítimo ni aduana; normalmente de 2 a 5 días en camino. Usted no tiene que organizar nada.' },
