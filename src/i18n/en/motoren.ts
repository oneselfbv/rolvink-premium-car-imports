...
const motoren = {
  ...
  stappen: [
    ...
    { num: '05', title: 'Transport from Germany', body: 'We arrange the full transport from Germany to Welsum — insured, by trailer or enclosed transporter. Within the EU, so no sea freight and no customs; usually 2 to 5 days in transit. You do not have to organise anything.' },
  ...
  inclusief: [
    ...
    'Fully insured transport from Germany',
