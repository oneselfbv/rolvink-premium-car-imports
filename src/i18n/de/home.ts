...
const home = {
  meta: {
    title: 'BMW-Motorrad verkaufen — wir holen ab | Rolvink',
    description:
      'Wir kaufen BMW-Motorräder in ganz Deutschland — auch Standmotorräder ohne TÜV. Abholung mit eigenem Anhänger, Bezahlung bei Abholung, Abmeldung übernehmen wir.',
  },
  hero: {
    h1Html: 'Verkaufen Sie Ihr<br/><span class="accent">BMW-Motorrad</span>.',
    lead: 'Wir kommen aus den Niederlanden mit eigenem Anhänger, bezahlen bei Abholung und übernehmen die Abmeldung. Auch Standmotorräder ohne TÜV.',
    ctaPrimary: 'Motorrad anbieten',
    ...
    brands: [
      ...
      { label: 'R- und GS-Modelle' },
      { label: 'K-Serie' },
      { label: 'Klassiker ab 1970' },
    ] as Array<{ label: string; href?: string }>,
    sourceLabel: 'Abholung',
    sources: [
      { label: 'Eigener Anhänger' },
      { label: 'Zwei Motorräder pro Fahrt' },
    ] as Array<{ label: string; href?: string }>,
  },
  obsession: {
  ...
  verkaufen: {
    ...
    heading: 'Wir kaufen Ihr Motorrad.',
    lead: 'Kein Inseratsstress, keine Besichtigungstouristen, kein Feilschen am Telefon. Wir sehen uns das Motorrad an, machen ein Angebot und holen es selbst ab.',
    items: [
      {
        num: '01',
        title: 'Was wir suchen',
        body: 'Alle BMW-Motorräder — Airhead, Boxer, R-Serie, GS, K-Serie, alt wie neu. Kein festes Modellraster: ob wir kaufen, entscheiden Zustand und Preis. Auch Scheunenfunde und Standmotorräder, solange die Papiere da sind.',
      },
      {
        num: '02',
        title: 'So läuft es ab',
        body: 'Fotos und Fahrzeugpapiere per WhatsApp oder E-Mail. Wir melden uns mit einem Preis. Passt es, machen wir einen Termin.',
      },
      {
        num: '03',
        title: 'Abholung',
        body: 'Wir kommen mit eigenem Anhänger — zwei Motorräder pro Fahrt. Bezahlung bei Abholung, die Abmeldung übernehmen wir.',
      },
      {
        num: '04',
        title: 'Ehrlich gesagt',
        body: 'Wir kaufen zum Händlerpreis, nicht zum Privatpreis. Dafür ohne Aufwand, ohne Wartezeit und ohne Rückfragen nach dem Verkauf.',
      },
    ],
  },
  autoblok: {
  ...
  cta: {
    ...
    body: 'Schicken Sie ein paar Fotos und die Fahrzeugpapiere — wir melden uns mit einem Preis. Unverbindlich.',
    primary: 'Motorrad anbieten',
